...
# 1. UI & THEME
st.set_page_config(page_title="SkyGuard Perak IoT", layout="wide", page_icon="🛰️")

st.markdown("""
    <style>
    .stApp { background-color: #F0F7FA; font-family: 'Segoe UI', sans-serif; }
    .glass-card {
    ...
    .metric-hero { font-size: 28px; font-weight: bold; color: #01579B; margin: 0; }
    .metric-sub { font-size: 11px; color: #666; text-transform: uppercase; }
    </style>
...
<div style="font-size: 13px; color: #444; line-height: 1.6;">
    • <b>Muhammad Firman Hakim bin Che Ramlee</b> <span style="color:#777;">(22012176)</span><br>
    • <b>Che Faris Iskandar bin Che Azizi</b> <span style="color:#777;">(22012057)</span><br>
    • <b>Muhammad Hakim bin Majir</b> <span style="color:#777;">(22011168)</span>
</div>
""", unsafe_allow_html=True)
